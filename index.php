...
<div id="container">
  <div class="wrapper">
    <div id="content">
      ...
      <p>ClinicoSight system aims to help the Arogya Polyclinic patients to take  appointment online through internet and track their records through it. PolyClinic is web based application which covers all aspects of management and operations of clinics. This website covers  Doctors Details, Patients Records, Online appointments, Patient reports, billings, Clinical tests,  etc.</p>
      <p>By  using ClinicoSight, a clinic can better and more optimally manage the  availability of their resources; it does this by integrating with the clinic&rsquo;s  existing appointment system. This means the ClinicoSight system can add or  update the clinic&rsquo;s own appointment schedule 24 hours a day, 7 days a week. <br />
        <br />
The ClinicoSight  informs toArogya Polyclinic patients which appointment  slots are empty, and then the ClinicoSight system will automatically provide  new appointments. <br />
      </p>
    </div>
    <div id="column">
      <div class="holder">
        ...
        <ul id="latestnews">
          <li> <img class="imgl" src="images/demo/100x75.gif" alt="" />
            <p><strong><a href="#">Patient Appointment Booking System.</a></strong></p>
            <p>Patients can take appointments through online.</p>
          </li>
